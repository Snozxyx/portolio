...
export function FocusRail({
    ...
    return (
        <div
            className={cn(
                "group relative flex h-[600px] w-full flex-col overflow-hidden bg-black text-white outline-none select-none",
                className
            )}
                    ...
                    {visibleIndices.map((offset) => {
                        ...
                        return (
                            <motion.div
                                key={absIndex}
                                className={cn(
                                    "absolute aspect-[3/4] w-[260px] md:w-[300px] rounded-2xl border-t border-white/10 bg-neutral-900 shadow-2xl transition-shadow duration-300",
                ...
                <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                {activeItem.description && (
                                    <p className="max-w-md text-neutral-500 font-light text-sm">
                                        {activeItem.description}
                                    </p>
                                )}
                            </motion.div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-1 rounded-full bg-neutral-900/40 p-1 ring-1 ring-white/10 backdrop-blur-md">
                            ...
                            <span className="min-w-[40px] text-center text-xs font-mono text-neutral-600">
                                {activeIndex + 1} / {count}
                            </span>
                            <button
                                onClick={handleNext}
