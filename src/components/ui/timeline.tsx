    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                <h2 className="text-3xl md:text-5xl mb-4 text-white max-w-4xl tracking-tight font-bold">
                    The Journey
                </h2>
                <p className="text-neutral-500 text-sm md:text-base max-w-sm font-light">
                    A brief history of my evolving craft and the milestones that shaped my perspective.
                </p>
            </div>
